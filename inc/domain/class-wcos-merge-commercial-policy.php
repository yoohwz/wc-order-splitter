...
final class WCOS_Merge_Commercial_Policy {
	...
	public static function authority(WC_Order $source, WC_Order $target, $precision) {
		...
		return self::canonicalize_authority(array(
			...
			'line_disposition' => 'canonical_identity_coalesce_or_fresh',
	...
	public static function expected_target_signature(WC_Order $source, WC_Order $target, $precision) {
		return WCOS_Mutation_Fingerprint::create(
	...
	public static function target_signature(WC_Order $target, $precision, $source_order_id) {
		return WCOS_Mutation_Fingerprint::create(
			'merge_ordinary_active_economic_v1',
