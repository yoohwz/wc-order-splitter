...
assert_contains "$ci_workflow" 'grep -Fqx -- "- **CI profile floor:** \`$INPUT_REQUESTED_PROFILE\`" <<< "$issue_body"'
...
assert_contains "$ci_workflow" "'Required CI' || 'PRECHECK authority only'"
